...
function injectAIButton(screen){
  ...
  row.innerHTML =
    '<div style="flex:1;min-width:160px;">' +
      '<div style="font-weight:700;color:#c4b5fd;font-size:.84rem;display:flex;align-items:center;gap:6px;">🆕 New Practice Paper</div>' +
      '<div style="color:rgba(255,255,255,.62);font-size:.74rem;line-height:1.45;">Fresh questions matching this exam\'s syllabus and structure.</div>' +
    '</div>' +
    '<button class="exg-ai-btn" type="button" style="background:linear-gradient(135deg,#a855f7,#7c3aed);color:#fff;border:0;padding:8px 14px;border-radius:8px;font-weight:700;font-size:.82rem;cursor:pointer;font-family:inherit;white-space:nowrap;">Get Paper →</button>';
