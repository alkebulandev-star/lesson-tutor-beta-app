...
(function(){
  ...
  function injectStyles(){
    ...
    s.textContent = ''
      + '#pg-social{position:fixed;inset:0;overflow-y:auto;background:radial-gradient(900px 500px at 90% -10%,rgba(168,85,247,.22),transparent 60%),radial-gradient(800px 500px at 0% 100%,rgba(236,72,153,.18),transparent 60%),radial-gradient(600px 400px at 50% 50%,rgba(59,130,246,.1),transparent 60%),#070b18;color:#fff;font-family:Inter,system-ui,sans-serif;display:none;z-index:50}'
      + '#pg-social.active{display:block}'
      + '.sc-wrap{max-width:680px;margin:0 auto;padding:18px 16px 80px}'
      ...
      + '.sc-title{font-family:"Bricolage Grotesque",sans-serif;font-weight:900;font-size:1.5rem;display:flex;gap:8px;align-items:center;background:linear-gradient(135deg,#fbbf24,#f97316,#ec4899);-webkit-background-clip:text;background-clip:text;color:transparent}'
      + '.sc-tabs{display:flex;gap:6px;background:rgba(255,255,255,.04);backdrop-filter:blur(8px);border:1px solid rgba(255,255,255,.08);padding:5px;border-radius:14px;margin-bottom:16px;overflow-x:auto;position:sticky;top:0;z-index:5}'
      + '.sc-tab{flex:1;min-width:84px;background:transparent;border:none;color:rgba(255,255,255,.7);padding:10px 12px;border-radius:10px;font-weight:800;font-size:.82rem;cursor:pointer;font-family:inherit;white-space:nowrap;transition:all .18s}'
      + '.sc-tab:hover{background:rgba(255,255,255,.06)}'
      + '.sc-tab.on{background:linear-gradient(135deg,#ec4899,#f97316);color:#fff;box-shadow:0 6px 18px rgba(236,72,153,.45)}'
      // ── Card: feels like an Instagram post ──
      + '.sc-card{background:linear-gradient(180deg,rgba(255,255,255,.06),rgba(255,255,255,.02));border:1px solid rgba(255,255,255,.1);border-radius:18px;padding:16px;margin-bottom:14px;backdrop-filter:blur(8px);transition:transform .15s, box-shadow .15s}'
      + '.sc-card:hover{transform:translateY(-1px);box-shadow:0 12px 36px rgba(0,0,0,.35)}'
      + '.sc-row{display:flex;align-items:center;gap:12px;padding:12px 6px;border-bottom:1px solid rgba(255,255,255,.06)}'
      + '.sc-row:last-child{border-bottom:none}'
      // ── Avatar: Instagram-style gradient ring ──
      + '.sc-av{width:46px;height:46px;border-radius:50%;background:linear-gradient(135deg,#ec4899,#f97316,#fbbf24);display:flex;align-items:center;justify-content:center;font-size:1.3rem;flex-shrink:0;padding:2.5px;position:relative}'
      + '.sc-av::before{content:"";position:absolute;inset:2.5px;background:#0b1222;border-radius:50%;z-index:0}'
      + '.sc-av > *,.sc-av{position:relative}'
      + '.sc-av > span,.sc-av img{position:relative;z-index:1;display:flex;align-items:center;justify-content:center;width:100%;height:100%}'
      + '.sc-av.lg{width:96px;height:96px;font-size:2.5rem;padding:3.5px}'
      + '.sc-av.lg::before{inset:3.5px}'
